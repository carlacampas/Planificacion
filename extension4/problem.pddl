(define (problem extension3) (:domain hotel)
    ...
    (:init
       ...
       ;(= ( end_day r88) 30)
        ...
        (= (tamano_habitacion h2) 1)
        (= (tamano_habitacion h3) 1)
        (= (tamano_habitacion h4) 1)
    ...
    (:metric maximize (+ (+ (/ (xctj_ocupacion) (cantidad_reservas)) (/ (habitaciones_unused) 4)) (/ (cantidad_reservas) (- 8 (reservas_descartadas)))))
